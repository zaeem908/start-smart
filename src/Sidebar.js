    ...
    return (
     ...
     <div className="flex">
        <aside className="w-44 flex flex-col p-5 m-3 mt-0 left-0 top-0 rounded-xl bg-gray-200">
            <Link to={"/dashboard"} className="hover:bg-gray-400 mb-3 bg-gray-300 hover:text-white text-lg text-gray-500 p-4 rounded-xl">Dashboard</Link>
            <Link className="hover:bg-gray-400 mb-3  bg-gray-300 hover:text-white text-lg text-gray-500 p-4 rounded-xl">Attendance</Link>
            ...
            <Link className="hover:bg-gray-400 mb-3  bg-gray-300 hover:text-white text-lg text-gray-500 p-4 rounded-xl">Teachers</Link>
        ...
        <main className="flex-1 ml-auto rounded-lg">
            <div className="text-center">
                <h1 className="text-4xl mb-4 font-bold text-gray-500">Choose your Teacher</h1>
            </div>
            <div>
