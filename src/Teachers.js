...
<div className="flex flex-row">
    <div class="w-[20%] m-4 bg-white border border-gray-200 rounded-lg shadow-xl dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-2">
                ...
                <h4 className="px-12 text-xs">Subject: Science</h4>
            <div><button className="px-[40%] bg-gray-300 hover:bg-gray-500 hover:text-white m-2 rounded-xl">Add</button></div>
        </div>
    </div>
    <div class="w-[20%] m-4 bg-white border border-gray-200 rounded-lg shadow-xl dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-2">
                ...
                <h4 className="px-4 text-xs">Subject: English Literature</h4>
            <div><button className="px-[40%] bg-gray-300 hover:bg-gray-500 hover:text-white m-2 rounded-xl">Add</button></div>
        </div>
    </div>
    ...
    <div class="w-[20%] m-4 bg-white border border-gray-200 rounded-lg shadow-xl dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-2">
                ...
                <h4 className="px-12 text-xs">Subject: Physics</h4>
            <div><button className="px-[40%] bg-gray-300 hover:bg-gray-500 hover:text-white m-2 rounded-xl">Add</button></div>
        </div>
    </div>
    ...
    <div class="w-[20%] m-4 bg-white border border-gray-200 rounded-lg shadow-xl dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-2">
                ...
                <h4 className="px-8 text-xs">Subject: Economics</h4>
            <div><button className="px-[40%] bg-gray-300 hover:bg-gray-500 hover:text-white m-2 rounded-xl">Add</button></div>
        </div>
    </div>
    ...
    <div class="w-[20%] m-4 bg-white border border-gray-200 rounded-lg shadow-xl dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-2">
                ...
                <h4 className="px-8 text-xs">Subject: Mathematics</h4>
            <div><button className="px-[40%] bg-gray-300 hover:bg-gray-500 hover:text-white m-2 rounded-xl">Add</button></div>
        </div>
    </div>
